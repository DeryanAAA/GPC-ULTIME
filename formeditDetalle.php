			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Editar Detalle</h2>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladoreditDetalle.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="DESC_DET"   id="DESC_DET" value="<?php  echo $row['DESC_DET']; ?> " required/> </div>
							  
<input type="hidden"  id="ID_DETALLE" name="ID_DETALLE" value="<?php  echo $row['ID_DETALLE']; ?> " >
                          </div>
