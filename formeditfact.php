			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Editar Factura</h2>
					</div>
				</div>
			</div>
			<div class="row">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
							 <?php 
								...
								<select class="form-control" name="ID_CL" id="ID_CL" >
								<?php 
									while ($row3 = $resultado3->fetch_array() )
									{
										if($row3['ID_CL']==$ID_CL)
										{?>
											<option value=" <?php echo$row3['ID_CL'] ?>" selected>
										<?php echo $row3['NOM_CL']; ?>
										</option>
										<?php }
										else{
									?>
										<option value=" <?php echo$row3['ID_CL'] ?>">
										<?php echo $row3['NOM_CL']; ?>
										</option>
										<?php }} ?>
								</select>
