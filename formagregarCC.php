			...
			<div class="">
			  <div class="card-body">
				<div class="d-flex justify-content-between border-bottom">
				  <h2 class="text-primary">Agregar Centro de Costo</h2>
				</div>
			  </div>
			</div>
			<div class="row">
			  ...
			  <div class="col-12 grid-margin">
				<div class="card">
				  <div class="card-body">
					...
					<form class="form-sample" method="post" action="controladoragregarCC.php">
					  <div class="row">
						<div class="col-md-6">
						 <div class="form-group row">
							<label class="col-sm-3 col-form-label">Nombre CC:</label>
							<div class="col-sm-9">
							  <input type="text" class="form-control" name="NOM_CC"	 id="NOM_CC" required/> </div>
						  </div>
							   ...
							   <?php 
								...
								<div class="col-sm-9">
									...
									<?php 
										...
										<option value=" <?php echo $row['ID_LINEA'] ?> " ><?php echo $row['NOM_LINEA']; ?></option>
										<?php
										}?>
									</select>
								</div>
						...
						<div class="form-group row">
							...
							<?php 
								...
								<div class="col-sm-9">
									...
									<?php 
										while ( $row = $result->fetch_array() ) {?>
										<option value=" <?php echo $row['ID_AGRUP'] ?> " ><?php echo $row['NOM_AGRUP']; ?></option>
										<?php
										}?>
									</select>
								</div>
						 ...
						 <div class="form-group row">
							<label class="col-sm-3 col-form-label">Detalle:</label>
								...
								<div class="col-sm-9">
									...
									<?php 
										while ( $row = $result->fetch_array() ) {?>
										<option value=" <?php echo $row['ID_DETALLE'] ?> " ><?php echo $row['DESC_DET']; ?></option>
										<?php
										}?>
									</select>
								</div>
					  ...
					  <div class="row">
						...
						<div class="form-group row">
							...
							<?php 
								...
								?>	
								<div class="col-sm-9">
									<select	 class="form-control" name="estadocc" id="estadocc" required>
									<option value="" >Seleccione</option>
