				 ...
				 <div class="row">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							?>	
								  <div class="form-group row">
									<label class="col-sm-3 col-form-label">Supervisor Interno:</label>
									<div class="col-sm-9">
									   <select class="form-control" name="supentel" id="supentel" required>
									   <option value="" selected> Seleccione... </option>
							<?php 
					  ...
					  <div class="row">
						<div class="col-md-6">
						  <div class="form-group row">
							...
							<div class="col-sm-9">
							  <input type="text" name="creadopor" id="creadopor" class="form-control" value="<?php echo $nombreuser;?>" readonly/> 
