          ...
          <div class="content-wrapper">
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Asignar OC a Factura</h2>
            ...
            ?>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Asignar OC a Factura</h4>
                    ...
                    <form class="form-sample" method="post" action="controladoragregaroc.php">
                        
                         <div class="row">
                             
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Número OC:</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="ocfactura" id="ocfactura" required/> </div>
