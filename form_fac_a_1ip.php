			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Asignar Factura a Informe de Pago</h2>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladorfac_a_1ip.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
							   ...
							   <section class="form-control"> <?php echo $nfactura; ?> </section>
							  </div>
                              
                               <input type="hidden" class="form-control" name="nfactura" id="nfactura" value="<?php  echo $nfactura ?>"/>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group row">
                            ...
                            <select  class="form-control" name="ipfac" id="ipfac">
                      ...
                      <div class="row">
                        ...
                        <?php
                         echo "<td><a href= 'form_fac_a_ips.php?nfactura=".$nfactura."&vfactura=".$vfactura."&idfactura=".$idfactura."'><button type='button' class='btn btn-danger' onclick='return confirmDelete()'>Asignar muchas ip </button></a> </td>";
