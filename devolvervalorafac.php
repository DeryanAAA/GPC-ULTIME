		  ...
		  <div class="">
                <div class="card-body">
                    <div class="d-flex justify-content-between border-bottom">
                        <h2 class="text-primary">Devolver Dinero</h2>
                    </div>
                </div>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladordevolver.php">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Valor a devolver</label>
                            <div class="col-sm-9">
                                
                             <input type="number" name="valor" id="cp">
                             <input type="hidden" name="id_fact" id="cp" value=<?php echo $id_fact; ?>>
                            </div>
                          </div>
                        </div>
                             ...
                             <button type="submit" class="btn btn-success mr-2">Agregar</button>
                              ...
                              <a href="formeditfact.php?ID_FACT=<?php echo $id_fact; ?>"><input class="btn btn-light" type="button" value="Cancelar"></a>
