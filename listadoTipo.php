          ...
          <div class="content-wrapper">
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Tipo de Proyecto</h2>
			...
			<div class="col-md-6 grid-margin stretch-card">
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Listado Tipo de Proyecto</h4>
                      ...
                      <p class="text-right">   
							...
							<a title= "Agregar Tipo Proyecto" href="formagregarTipo.php">
								<button  type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Tipo Proyecto</button>
							</a>
						</p>  
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                               ...
                               <a href='formeditTipo.php?id=<?PHP echo $fila['ID_TIPO']; ?>'> <section class='imgtb'></section></a>
                             <a href= 'detalleTipo.php?id=<?PHP echo $fila['ID_TIPO']; ?>'><section class='dtl'></section></a> 
                            </td>
                          </tr>
