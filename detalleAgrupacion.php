			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Detalle Agrupación</h2>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladoreditAgrupacion.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="NOM_AGRUP"   id="NOM_AGRUP" value="<?php  echo $row['NOM_AGRUP']; ?> " disabled required/> </div>
							  
<input type="hidden"  id="ID_AGRUP" name="ID_AGRUP" value="<?php  echo $row['ID_AGRUP']; ?> " >
                          </div>
