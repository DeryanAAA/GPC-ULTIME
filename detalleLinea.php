			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Detalle de Línea de Negocio</h2>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladoreditLinea.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="NOM_LINEA"   id="NOM_LINEA" value="<?php  echo $row['NOM_LINEA']; ?> " disabled required/> </div>
							  
<input type="hidden"  id="ID_LINEA" name="ID_LINEA" value="<?php  echo $row['ID_LINEA']; ?> " >
                          </div>
                             ...
                             <a href="listadoLinea.php"><input class="btn btn-success" type="button" value="Volver"></a>
