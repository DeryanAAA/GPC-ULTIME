  ...
  <body>
    <div class="container-scroller">
      ...
      //Validar conexión.
			...
			$consulta = "SELECT C.ID_CIUDAD,R.NOM_REGION,C.NOM_CIUDAD FROM CIUDAD AS C INNER JOIN REGION AS R ON R.ID_REGION=C.ID_REGION";
			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Ciudad</h2>
                  ...
                  <div class="card-body">
                    <h4 class="card-title">Listado de Ciudades</h4>
                      ...
                      <p class="text-right">   
							...
							<a title= "Agregar Cliente" href="formagregarCiudad.php">
								<button  type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Ciudad</button>
							</a>
						</p>  
                      ...
                      <table id="order-listing" class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php  echo $fila['NOM_REGION']; ?></td>
                            ...
                            <td>
                               ...
                               <a href='formeditCiudad.php?id=<?PHP echo $fila['ID_CIUDAD']; ?>'> <section class='imgtb'></section></a>
                             <a href= 'detalleCiudad.php?id=<?PHP echo $fila['ID_CIUDAD']; ?>'><section class='dtl'></section></a> 
                            </td>
                          </tr>
