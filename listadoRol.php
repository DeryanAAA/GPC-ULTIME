                  ...
                  <div class="card-body">
                    <h4 class="card-title">Listado de Roles</h4>
                      ...
                      <p class="text-right">   
							...
							<a title= "Agregar Rol" href="formagregarRol.php">
								<button  type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Rol</button>
							</a>
						</p>  
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                               ...
                               <a href='formeditRol.php?id=<?PHP echo $fila['ID_ROL']; ?>'> <section class='imgtb'></section></a>
                             <a href= 'detalleRol.php?id=<?PHP echo $fila['ID_ROL']; ?>'><section class='dtl'></section></a> 
                            </td>
                          </tr>
