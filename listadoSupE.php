          ...
          <div class="content-wrapper">
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Supervisor Externo</h2>
			...
			<div class="col-md-6 grid-margin stretch-card">
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Listado Supervisor Externo</h4>
                      ...
                      <p class="text-right">   
							...
							<a title= "Agregar Supervisor Externo" href="formagregarSupE.php">
								<button  type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Supervisor Externo</button>
							</a>
						</p>  
                    <div class="table-responsive">
                      ...
                      <table id="order-listing" class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?php  echo $fila['ID_SUPENTEL']; ?></td>
                            <td><?php  echo $fila['NOM_SUPENTEL']; ?></td>
                            ...
                            <td>
                               ...
                               <a href='formeditSupE.php?id=<?PHP echo $fila['ID_SUPENTEL']; ?>'> <section class='imgtb'></section></a>
                             <a href= 'detalleSupE.php?id=<?PHP echo $fila['ID_SUPENTEL']; ?>'><section class='dtl'></section></a> 
                            </td>
                          </tr>
