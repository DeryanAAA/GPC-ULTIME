			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Editar Supervisor Externo</h2>
                    ...
                    <form class="form-sample" method="post" action="controladoreditSupE.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="NOM_SUPENTEL"  id="NOM_SUPENTEL" value="<?php  echo $row['NOM_SUPENTEL']; ?> "required/> </div>
                          </div>
                            <input type="hidden"  id="ID_SUPENTEL" name="ID_SUPENTEL" value="<?php  echo $row['ID_SUPENTEL']; ?> " >
                             ...
                             <button type="submit" class="btn btn-success mr-2">Editar</button>
                              <a href="listadoSupE.php"><input class="btn btn-light" type="button" value="Cancelar"></a>
