			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Editar Jefe Externo</h2>
                    ...
                    <form class="form-sample" method="post" action="controladoreditJefeE.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="NOM_JDE"   id="NOM_JDE" value="<?php  echo $row['NOM_JDE']; ?> " required/> </div>
...
<input type="hidden"  id="ID_JDE" name="ID_JDE" value="<?php  echo $row['ID_JDE']; ?> " >
                             ...
                             <button type="submit" class="btn btn-success mr-2">Editar</button>
                              <a href="listadoJefeE.php"><input class="btn btn-light" type="button" value="Cancelar"></a>
