			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Editar Línea de Negocio</h2>
                    ...
                    <form class="form-sample" method="post" action="controladoreditLinea.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="NOM_LINEA"   id="NOM_LINEA" value="<?php  echo $row['NOM_LINEA']; ?> " required/> </div>
