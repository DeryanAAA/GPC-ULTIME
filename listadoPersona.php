  ...
  <body>
    <div class="container-scroller">
      ...
      //Validar conexión.
			...
			$consulta = "SELECT * FROM CENTRO_DE_COSTO where ESTADO <> 'nulo'";
		  ...
		  <div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Listado Centros de Costos</h2>
                  ...
                  <div class="card-body">
                    <h4 class="card-title"></h4>
					 <p class="text-right">   
							...
							<a title= "Agregar CC" href="formagregarcc.php">
								<button  type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Centro de Costo</button>
							</a>
						</p>  
                      ...
                      <table id="order-listing" class="table">
                       ...
                       <thead>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?php   echo $fila['ID_CC']; ?></td>
                            <td><?php  echo ucfirst($fila['NOM_CC']); ?></td>
                              
                              
                            <?php 
                               $query3="SELECT * FROM LINEA_DE_NEGOCIO, CENTRO_DE_COSTO where LINEA_DE_NEGOCIO.ID_LINEA  = ".$fila['ID_LINEA'];
                        ...
                        $row3=$resultado3->fetch_assoc();
                            ...
                            <td>
                              ...
                              <?php echo ucfirst($row3['NOM_LINEA']); ?>
                              </td>  
                              
                              <td>
                        <?php      
                             $query4="SELECT * FROM AGRUPACION, CENTRO_DE_COSTO where AGRUPACION.ID_AGRUP  = ".$fila['ID_AGRUP'];
                        $resultado4= $conexion->query($query4);
                        $row4=$resultado4->fetch_assoc();
                       
                              
                              
                        echo ucfirst($row4['NOM_AGRUP']); ?>
                            ...
                            <td><?php   $query5="SELECT * FROM DETALLE, CENTRO_DE_COSTO where DETALLE.ID_DETALLE  = ".$fila['ID_DETALLE'];
                        $resultado5= $conexion->query($query5);
                        $row5=$resultado5->fetch_assoc();
    
                        echo ucfirst($row5['DESC_DET']); ?></td>
                              
                              
                            <td><?php echo ucfirst(strtolower($fila['ESTADO'])); ?></td>
                            ...
                            <td>
                             <a href= 'detallecc.php?cc=<?php echo $fila['ID_CC']; ?>'><section class='dtl'></section></a>
                            <a href='formeditcc.php?cc=<?php echo $fila['ID_CC']; ?>'> <section class='imgtb'></section></a>
                            <a href= 'controladoreliminarcc.php?cc=<?php echo $fila['ID_CC']; ?>'><section class='elim'></section></a>
