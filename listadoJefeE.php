  ...
  <body>
    <div class="container-scroller">
      ...
      //Validar conexión.
			...
			$consulta = "SELECT * FROM jefe_entel";
          ...
          <div class="content-wrapper">
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Jefe Externo</h2>
			...
			<div class="col-md-6 grid-margin stretch-card">
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Listado Jefe Externo</h4>
                      ...
                      <p class="text-right">   
							...
							<a title= "Agregar Jefe Externo" href="formagregarJefeE.php">
								<button  type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Jefe Externo</button>
							</a>
						</p>  
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                               ...
                               <a href='formeditJefeE.php?id=<?PHP echo $fila['ID_JDE']; ?>'> <section class='imgtb'></section></a>
                             <a href= 'detalleJefeE.php?id=<?PHP echo $fila['ID_JDE']; ?>'><section class='dtl'></section></a> 
                            </td>
                          </tr>
