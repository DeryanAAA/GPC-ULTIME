		...
		$row=$resultado->fetch_assoc();
		  ...
		  $estado=$row['ESTADO'];
			  ...
			  <div class="col-12 grid-margin">
				<div class="card">
				  <div class="card-body">
					<h4 class="card-title">Editar CC</h4>
					<form class="form-sample" method="post" action="controladoreditarcc.php">
					<div class="row">
						<div class="col-md-6">
						 <div class="form-group row">
							<label class="col-sm-3 col-form-label">Nombre CC:</label>
							<input type="hidden"  id="ID_CC" name="ID_CC" value="<?php echo $cc?>">
							<div class="col-sm-9">
							  <input type="text" class="form-control" name="NOM_CC"	 id="NOM_CC" value="<?php echo $row['NOM_CC']; ?>" required/> </div>
						  </div>
						...
						<div class="col-md-6">
						 <div class="form-group row">
							<label class="col-sm-3 col-form-label">Línea de Negocio:</label>
							   <?php 
								$query = "SELECT * FROM linea_de_negocio";
								...
								<div class="col-sm-9">
									...
									<?php 
										while ( $row1 = $result->fetch_array() ) {
											if($row1['ID_LINEA']==$linea){
												?><option value="<?php echo $row1['ID_LINEA'] ?>" selected ><?php echo $row1['NOM_LINEA']; ?></option><?php
											}else{
												?><option value="<?php echo $row1['ID_LINEA'] ?>"  ><?php echo $row1['NOM_LINEA']; ?></option><?php
											}
											?>
					   ...
					   <div class="row">
						<div class="col-md-6">
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">Agrupación CC:</label>
							<?php 
								...
								<div class="col-sm-9">
									<select	 class="form-control" name="ID_AGRUP" id="ID_AGRUP" required>
									<?php 
										while ( $row1 = $result->fetch_array() ) {
											if($row1['ID_AGRUP']==$agrupacion){
												?><option value="<?php echo $row1['ID_AGRUP'] ?>" selected ><?php echo $row1['NOM_AGRUP']; ?></option><?php
											}else{
												?><option value="<?php echo $row1['ID_AGRUP'] ?>"  ><?php echo $row1['NOM_AGRUP']; ?></option><?php
											}
											?>
						...
						<div class="col-md-6">
						 <div class="form-group row">
							<label class="col-sm-3 col-form-label">Detalle:</label>
								...
								<div class="col-sm-9">
									<select	 class="form-control" name="ID_DETALLE" id="ID_DETALLE" required>
									<?php 
										while ( $row1 = $result->fetch_array() ) {
											if($row1['ID_DETALLE']==$detalle){
												?><option value="<?php echo $row1['ID_DETALLE'] ?>" selected ><?php echo $row1['DESC_DET']; ?></option><?php
											}else{
												?><option value="<?php echo $row1['ID_DETALLE'] ?>"  ><?php echo $row1['DESC_DET']; ?></option><?php
											}
											?>
						...
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">Estado:</label>
								...
								<div class="col-sm-9">
									...
									<?php 
											...
											if($estado=="Activo"){
												...
												<option value="Cerrado"  >Cerrado</option><?php
											}else{
							 ...
							 <button type="submit" class="btn btn-success mr-2">Editar</button>
							  <a href="listadocc.php"><input class="btn btn-light" type="button" value="Cancelar"></a>
