				  ...
				  <div class="card-body">
					<h4 class="card-title"></h4>
					   <p class="text-right">	
						...
						<!--	<a title= "Agregar Proyecto" href="formproyectos.php">
					  ...
					  <table id="order-listing" class="table table-striped">
						...
						<tbody>
						  ...
						  <tr>
							...
							<td	 class="text-capitalize"><a title="Ir a Fases del Proyecto" href='listadofases.php?cp=<?PHP echo $fila['CP']; ?>&p=<?PHP echo $fila['NOMBRE']; ?>'><?php echo $fila['NOMBRE'];?></a></td>
						...
						$row3=$resultado3->fetch_assoc(); ?>
							...
							<td>
							 ...
							 <a href= 'detalleproyecto.php?cp=<?PHP echo $fila['CP']; ?>'><section class='dtl' title="Ver"></section></a>	
							</td>
						  </tr>
						<?php	 }
						  ?>
