    ...
    <div class="container-scroller">
     ...
     <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="container-fluid page-body-wrapper">
		  ...
		  <div class="">
			<div class="card-body">
				<div class="d-flex justify-content-between border-bottom">
					<h2 class="text-primary">Editar datos del Servicio</h2>
        ...
        $query="SELECT ip.ID_IP , ip.ID_CCosto, ip.CP, ip.ID_EO_COB, ip.NRO_COTI, ip.FECHAENVIOIP, ip.VALOR_IP, ip.OBSERVACIONES, ip.ID_TIPO, c.CP, c.NOMBRE, c.ID_EO_PROYECTO, tp.ID_TIPO, tp.NOM_TIPO
        ...
        $ID_EO_PROYECTO = $row['ID_EO_PROYECTO'];
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladoreditIPServicio.php">
                    ...
                    <!------------------------------------------------------------------------------------>
                      ...
                      <div class="col-md-6">
						<div class="form-group row">
							...
							<div class="col-sm-9">
                            <input type="hidden" class="form-control" name="tipo" id="tipo" value="<?php echo $row['ID_TIPO'] ; ?>">
                                <input type="text" class="form-control" name="top" id="top" value="<?php echo $row['NOM_TIPO'] ; ?>" readonly>
            ...
            <div class="col-md-6">
                    ...
                    <div class="col-md-6">
						<div class="form-group row">
							...
							<div class="col-sm-9">
							 <?php 
								...
								<?php 
									while ($row3 = $resultado3->fetch_array() )
									{
										if($row3['ID_EO_PROYECTO']==$ID_EO_PROYECTO)
										{?>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input class="form-control" type="text" name="nom" id="nom" value="<?php echo $row['NOMBRE']; ?>" >
                            </div>
                          </div>
                        </div>    
                      </div>
                    ...
                    <!------------------------------------------------------------------------------------>
                             <button type="submit" class="btn btn-success mr-2">Modificar IP</button>
                              <input class="btn btn-light" type="button" value="Listar IP de Servicios Fijos" onclick="cancelar()">
	...
	<script>
		function cancelar(){
			if (confirm("¿Desea listar los Reportes de Cobranza?")){
				window.location.href="detallesServiciosFijos.php";
			}
		}
	</script>
    <!-- inject:js -->
