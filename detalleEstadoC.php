			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Detalle Estado de Cobranza</h2>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladoreditEstadoC.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="NOM_EO_COB"   id="NOM_EO_COB" value="<?php  echo $row['NOM_EO_COB']; ?> " disabled required/> </div>
							  
<input type="hidden"  id="ID_EO_COB" name="ID_EO_COB" value="<?php  echo $row['ID_EO_COB']; ?> " >
                          </div>
                             ...
                             <a href="listadoEstadoC.php"><input class="btn btn-success" type="button" value="Volver"></a>
