...
<span class="mdi mdi-menu"></span>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="tables">
				...
				WHERE c.ID_TIPO='1' and (c.ID_EO_COB<>5 and c.ID_EO_COB<>6) and (c.ID_CC=21 or c.ID_CC=22 or c.ID_CC=23 or c.ID_CC=24 or c.ID_CC=27)
                    ...
                    <div class="main-panel">
                        <div class="content-wrapper">
							...
							<div class="">
							  <div class="card-body">
								<div class="d-flex justify-content-between border-bottom">
								  <h2 class="text-primary">Reporte de Desempeño Proyecto Ranco</h2>
                                ...
                                <div class="col-md-12 grid-margin" style="font-size:14px;">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
											...
											inner join sistemaproyectos.informe_de_pago as i on c.CP=i.CP
											inner join sistemaproyectos.centro_de_costo as cc on c.ID_CC=cc.ID_CC
											WHERE c.ID_TIPO='1' and (c.ID_EO_COB<>5 and c.ID_EO_COB<>6) and (c.ID_CC=21 or c.ID_CC=22 or c.ID_CC=23 or c.ID_CC=24 or c.ID_CC=27) and YEAR(c.INI_REAL)=".$fila['año'] ."
                                                        ...
                                                        <div class="card-body">
                                                            <div class="card-body">
                                                                ...
                                                                <table class="table table-striped table-responsive-lg">
																	...
																	inner join sistemaproyectos.informe_de_pago as i on c.CP=i.CP
																	inner join sistemaproyectos.centro_de_costo as cc on c.ID_CC=cc.ID_CC
																	WHERE c.ID_TIPO='1' and (c.ID_EO_COB<>5 and c.ID_EO_COB<>6) and (c.ID_CC=21 or c.ID_CC=22 or c.ID_CC=23 or c.ID_CC=24 or c.ID_CC=27) and YEAR(c.INI_REAL)=".$fila['año'] ." and MONTH(c.INI_REAL)=".$fil['MES'] ."
                            ...
                            <div class="row" style="font-size:14px;">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="faq-section">
												...
												from sistemaproyectos.concepto as c 
												inner join sistemaproyectos.informe_de_pago as i on c.CP=i.CP
												WHERE c.ID_TIPO='1' and ( c.ID_EO_COB<>5 and c.ID_EO_COB<>6) and (c.ID_CC=21 or c.ID_CC=22 or c.ID_CC=23 or c.ID_CC=24 or c.ID_CC=27) and YEAR(c.INI_REAL)=".$fila4['año']."
												group by MES;";
                                                    ...
                                                    <div id="<?php echo $collapse5;?>" class="collapse " aria-labelledby="headingTwo" data-parent="#accordion-2">
                                                            ...
                                                            <div class="card-body">
                                                                <table class="table table-striped table-responsive">
																	...
																	inner join sistemaproyectos.centro_de_costo as cc on c.ID_CC=cc.ID_CC
																	INNER join sistemaproyectos.informe_de_pago as i on c.cp=i.CP
																	WHERE c.ID_TIPO='1' and (c.ID_EO_COB<>5 and c.ID_EO_COB<>6) and (c.ID_CC=21 or c.ID_CC=22 or c.ID_CC=23 or c.ID_CC=24 or c.ID_CC=27) and YEAR(c.INI_REAL)=".$fila4['año']." and MONTH(c.INI_REAL)=".$fila5['MES']."
																	group by c.cp
																	order by NOM_CC, CP;";
								...
								FROM sistemaproyectos.concepto as c
								inner join sistemaproyectos.centro_de_costo as cc on c.ID_CC=cc.ID_CC
								WHERE c.ID_TIPO='1'  and (c.ID_EO_COB=4 ) and (c.ID_CC=21 or c.ID_CC=22 or c.ID_CC=23 or c.ID_CC=24 or c.ID_CC=27)
								group by cc.NOM_CC
								order by cc.NOM_CC;";
								...
								$nColl++;
									...
									?>
                                            ...
                                            <div class="faq-section">
												...
												FROM sistemaproyectos.concepto as c
												inner join sistemaproyectos.centro_de_costo as cc on c.ID_CC=cc.ID_CC
												WHERE c.ID_TIPO='1'  and (c.ID_EO_COB=4 ) and (c.ID_CC=21 or c.ID_CC=22 or c.ID_CC=23 or c.ID_CC=24 or c.ID_CC=27) and cc.NOM_CC='".$fila1['NOM_CC']."' order by  c.cp;";
												$resultado = mysqli_query($conexion, $consulta);
												$nCollapse3=0;
