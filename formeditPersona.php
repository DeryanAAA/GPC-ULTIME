			...
			<div class="row">
			  ...
			  <div class="col-md-6 grid-margin stretch-card">
			   ...
			   <?php 
				$ID_PERSONAS  = $_GET['id'];
	  include ("bd.php");
		$query="SELECT * FROM personas WHERE ID_CC ='$ID_PERSONAS'";
					...
					<div class="row">
						<div class="col-md-6">
						 <div class="form-group row">
							...
							<input type="hidden"  id="ID_PERSONAS" name="ID_PERSONAS" value="<?php echo $row['ID_PERSONAS']; ?>">
							<div class="col-sm-9">
							  <input type="text" class="form-control" name="RUT"	 id="RUT" value="<?php echo $row['RUT']; ?>" required/> </div>
						  </div>
						...
						<div class="col-md-6">
						 <div class="form-group row">
							...
							<input type="hidden"  id="ID_PERSONAS" name="ID_PERSONAS" value="<?php echo $ID_PERSONAS;?>">
							<div class="col-sm-9">
							  <input type="text" class="form-control" name="NOM_PERSONAS"	 id="NOM_PERSONAS" value="<?php echo $row['NOM_PERSONAS']; ?>" required/> </div>
						  </div>
								...
								<div class="col-sm-9">
									...
									<?php 
										while ( $row1 = $result->fetch_array() ) {
											if($row1['ID_ROL']==$ID_ROL){
												?><option value="<?php echo $row1['ID_ROL'] ?>" selected ><?php echo $row1['NOM_ROL']; ?></option><?php
											}else{
												?><option value="<?php echo $row1['ID_ROL'] ?>"  ><?php echo $row1['NOM_ROL']; ?></option><?php
											}
											?>
