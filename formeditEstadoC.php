			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Editar Estado de Cobranza</h2>
                    ...
                    <form class="form-sample" method="post" action="controladoreditEstadoC.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="NOM_EO_COB"   id="NOM_EO_COB" value="<?php  echo $row['NOM_EO_COB']; ?> " required/> </div>
