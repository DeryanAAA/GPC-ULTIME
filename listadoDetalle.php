                  ...
                  <div class="card-body">
                    <h4 class="card-title">Listado de Detalles</h4>
                      ...
                      <p class="text-right">   
							...
							<a title= "Agregar Detalle" href="formagregarDetalle.php">
								<button  type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Detalle</button>
							</a>
						</p>  
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                               ...
                               <a href='formeditDetalle.php?id=<?PHP echo $fila['ID_DETALLE']; ?>'> <section class='imgtb'></section></a>
                             <a href= 'detalleDetalle.php?id=<?PHP echo $fila['ID_DETALLE']; ?>'><section class='dtl'></section></a> 
                            </td>
                          </tr>
