			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Editar Ciudad</h2>
					 ...
					 <?php 
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="NOM_CIUDAD"  id="NOM_CIUDAD"  value="<?php  echo $row['NOM_CIUDAD']; ?> " required/> </div>
                          </div>
                             ...
                             <button type="submit" class="btn btn-success mr-2">Editar</button>
                              <a href="listadoCiudad.php"><input class="btn btn-light" type="button" value="Cancelar"></a>
