			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Cargo</h2>
                  ...
                  <div class="card-body">
                    <h4 class="card-title">Listado de Cargos</h4>
                      ...
                      <p class="text-right">   
							...
							<a title= "Agregar Cargo" href="formagregarCargo.php">
								<button  type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Cargo</button>
							</a>
						</p>  
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                               ...
                               <a href='formeditCargo.php?id=<?PHP echo $fila['ID_CARGO']; ?>'> <section class='imgtb'></section></a>
                             <a href= 'detalleCargo.php?id=<?PHP echo $fila['ID_CARGO']; ?>'><section class='dtl'></section></a> 
                            </td>
                          </tr>
