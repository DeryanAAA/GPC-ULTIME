			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Región</h2>
                  ...
                  <div class="card-body">
                    <h4 class="card-title">Listado de Regiones</h4>
                      ...
                      <p class="text-right">   
							...
							<a title= "Agregar Región" href="formagregarRegion.php">
								<button  type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Región</button>
							</a>
						</p>  
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                               ...
                               <a href='formeditRegion.php?id=<?PHP echo $fila['ID_REGION']; ?>'> <section class='imgtb'></section></a>
                             <a href= 'detalleRegion.php?id=<?PHP echo $fila['ID_REGION']; ?>'><section class='dtl'></section></a> 
                            </td>
                          </tr>
