			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Detalle Cliente</h2>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladoreditCliente.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="RUT_CL" id="RUT_CL" value="<?php  echo $row['RUT_CL']; ?> " disabled required /> </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="NOM_CL"  id="NOM_CL"  value="<?php  echo $row['NOM_CL']; ?> " disabled required/> </div>
                          </div>
                              ...
                              <a href="listadoCliente.php"><input class="btn btn-success" type="button" value="Volver"></a>
