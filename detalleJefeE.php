			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Detalle Jefe Externo</h2>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladoreditJefeE.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="NOM_JDE"   id="NOM_JDE" value="<?php  echo $row['NOM_JDE']; ?> " disabled required/> </div>
							  
<input type="hidden"  id="ID_JDE" name="ID_JDE" value="<?php  echo $row['ID_JDE']; ?> " >
                          </div>
                              ...
                              <a href="listadoJefeE.php"><input class="btn btn-success" type="button" value="Volver"></a>
