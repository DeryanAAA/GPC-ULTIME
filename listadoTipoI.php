  ...
  <body>
    <div class="container-scroller">
      ...
      //Validar conexión.
			...
			$consulta = "SELECT * FROM tipo_informe";
          ...
          <div class="content-wrapper">
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Tipo de Informe</h2>
			...
			<div class="col-md-6 grid-margin stretch-card">
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Listado Tipo de Informe</h4>
                      ...
                      <p class="text-right">   
							...
							<a title= "Agregar Tipo Informe" href="formagregarTipoI.php">
								<button  type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Tipo Informe</button>
							</a>
						</p>  
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                               ...
                               <a href='formeditTipoI.php?id=<?PHP echo $fila['ID_TIPO']; ?>'> <section class='imgtb'></section></a>
                             <a href= 'detalleTipoI.php?id=<?PHP echo $fila['ID_TIPO']; ?>'><section class='dtl'></section></a> 
                            </td>
                          </tr>
