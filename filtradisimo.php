                    ...
                    <h4 class="card-title">Listado de Informes</h4>
						   ...
						   <p class="text-right">   
							...
							<a title= "Agregar Proyecto" href="formagrproyectocobranza.php">
								<button  type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Agregar Nuevo Proyecto</button>
							</a>
						</p>  
                      
                    <?php include "filtradopruebas.php" ?>
                    <?php 
                    include "filtradoprueba.php";
                    if($fila['VALOR_FACTURADO']>=$fila['VALOR_IP']){
                                
                                echo "Facturado";
                                    
                                   $sql = "UPDATE INFORME_DE_PAGO SET ESTADO='Facturado'";
                                    mysqli_query($conexion, $sql);
    
                                }else if($fila['VALOR_FACTURADO']<$fila['VALOR_IP']){
                                    
                                     echo "Enviado";
    
                                    $sql = "UPDATE INFORME_DE_PAGO SET ESTADO='Enviado'";
                                    mysqli_query($conexion, $sql);
                                }
                                ?>
