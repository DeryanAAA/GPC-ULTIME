			...
			<div class="">
			  <div class="card-body">
				<div class="d-flex justify-content-between border-bottom">
				  <h2 class="text-primary">Agregar Jefe Externo</h2>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladoragregarJefeE.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="NOM_JDE"  id="NOM_JDE" required/> </div>
                          </div>
	...
	<script>
		function cancelar(){
			if (confirm("¿Está seguro que desea cancelar?")){
				window.location.href="listadoJefeE.php";
			}
		}
	</script>
