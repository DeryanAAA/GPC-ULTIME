  ...
  <body>
    <div class="container-scroller">
      ...
      //Validar conexión.
			...
			$consulta = "SELECT * FROM agrupacion";
          ...
          <div class="content-wrapper">
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Agrupación</h2>
			...
			<div class="col-md-6 grid-margin stretch-card">
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Listado de Agrupaciones</h4>
                      ...
                      <p class="text-right">   
							...
							<a title= "Agregar Agrupacion" href="formagregarAgrupacion.php">
								<button  type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Agrupación</button>
							</a>
						</p>  
                    <div class="table-responsive">
                      ...
                      <table id="order-listing" class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?php  echo $fila['ID_AGRUP']; ?></td>
                            <td><?php  echo $fila['NOM_AGRUP']; ?></td>
                            ...
                            <td>
                               ...
                               <a href='formeditAgrupacion.php?id=<?PHP echo $fila['ID_AGRUP']; ?>'> <section class='imgtb'></section></a>
                             <a href= 'detalleAgrupacion.php?id=<?PHP echo $fila['ID_AGRUP']; ?>'><section class='dtl'></section></a> 
                            </td>
                          </tr>
