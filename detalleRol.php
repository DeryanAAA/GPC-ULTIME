			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Detalle Rol</h2>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladoreditRol.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="NOM_ROL"   id="NOM_ROL" value="<?php  echo $row['NOM_ROL']; ?> " disabled required/> </div>
							  
<input type="hidden"  id="ID_ROL" name="ID_ROL" value="<?php  echo $row['ID_ROL']; ?> " >
                          </div>
	...
	<script>
		function cancelar(){
			if (confirm("¿Está seguro que desea Volver?")){
				window.location.href="listadoRol.php";
			}
		}
	</script>
