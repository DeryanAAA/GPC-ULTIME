  ...
  <body>
    <div class="container-scroller">
      ...
      //Validar conexión.
			...
			$consulta = "SELECT * FROM estado_cobranza";
          ...
          <div class="content-wrapper">
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Estado de Cobranza</h2>
			...
			<div class="col-md-6 grid-margin stretch-card">
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Listado de Estados de Cobranzas</h4>
                      ...
                      <p class="text-right">   
							...
							<a title= "Agregar Estado de Cobranza" href="formagregarEstadoC.php">
								<button  type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Estado de Cobranza</button>
							</a>
						</p>  
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                               ...
                               <a href='formeditEstadoC.php?id=<?PHP echo $fila['ID_EO_COB']; ?>'> <section class='imgtb'></section></a>
                             <a href= 'detalleEstadoC.php?id=<?PHP echo $fila['ID_EO_COB']; ?>'><section class='dtl'></section></a> 
                            </td>
                          </tr>
