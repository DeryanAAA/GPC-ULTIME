			...
			<div class="">
			  <div class="card-body">
				<div class="d-flex justify-content-between border-bottom">
				  <h2 class="text-primary">Agregar Persona</h2>
				</div>
			  </div>
			</div>
			<div class="row">
			  ...
			  <div class="col-12 grid-margin">
				<div class="card">
				  <div class="card-body">
					...
					<form class="form-sample" method="post" action="controladoragregarPersona.php">
					  <div class="row">
						<div class="col-md-6">
						 <div class="form-group row">
							<label class="col-sm-3 col-form-label">RUT:</label>
							<div class="col-sm-9">
							  <input type="text" class="form-control" name="RUT"	 id="RUT" required/> </div>
						  </div>
						...
						<div class="col-md-6">
						 <div class="form-group row">
							...
							<div class="col-sm-9">
							  <input type="text" class="form-control" name="NOM_PERSONAS"	 id="NOM_PERSONAS" required/> </div>
						  </div>
					   ...
					   <div class="row">
						...
						<div class="col-md-6">
						 <div class="form-group row">
							...
							<div class="col-sm-9">
							  <input type="text" class="form-control" name="CLAVE"	 id="CLAVE" required/> </div>
						  </div>
	...
	<script>
		function cancelar(){
			if (confirm("¿Está seguro que desea cancelar?")){
				window.location.href="listadoPersona.php";
			}
		}
	</script>
