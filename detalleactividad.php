...
<html lang="en">
  ...
  <body>
	...
	<div class="card-body">
		<div class="d-flex justify-content-between border-bottom">
			<h2 class="text-primary">Detalle Actividad</h2>
                    ...
                    <form class="form-sample" method="post" action="controladoreditaractividad.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="nactividad" id="nactividad"  value="<?php echo $rowact['NOM_ACTIVIDAD']; ?>"disabled /> </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="dactividad"  id="dactividad" value="<?php echo $rowact['DESC_ACTIVIDAD']; ?>" disabled /> </div>
                          </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group row">
                            ...
                            <select  class="form-control" name="tactividad" id="tactividad" disabled>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="number" class="form-control" name="mactividad"  id="mactividad"  value=<?php echo $rowact['META_ACTIVIDAD']; ?> disabled/> </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
    ...
    ?>  
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9" name="eactividad" id="eactividad">
                              <select class="form-control" name="eactividad" id="eactividad" disabled>
                ...
                <?php echo $rowact['ENCARGADO']; ?>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="date" class="form-control" name="fiactividad"  id="fiactividad" placeholder="dd/mm/yyyy" value=<?php echo $rowact['FECHA_INICIO']; ?> disabled/> </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="date" name="ftactividad" id="ftactividad" class="form-control" value=<?php echo $rowact['FECHA_TERMINO']; ?> disabled  /> </div>
                          </div>
                        </div>
 ...
 ?>
                             ...
                             <input class="btn btn-primary" type="button" value="Volver" onclick="cancelar()">
