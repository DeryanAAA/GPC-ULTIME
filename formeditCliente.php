                    ...
                    <form class="form-sample" method="post" action="controladoreditCliente.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="RUT_CL" id="RUT_CL" value="<?php  echo $row['RUT_CL']; ?> " required /> </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="NOM_CL"  id="NOM_CL"  value="<?php  echo $row['NOM_CL']; ?> " required/> </div>
                          </div>
                             ...
                             <button type="submit" class="btn btn-success mr-2">Editar</button>
                              <a href="listadoCliente.php"><input class="btn btn-light" type="button" value="Cancelar"></a>
