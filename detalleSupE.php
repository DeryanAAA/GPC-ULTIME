			...
			<div class="">
				<div class="card-body">
					<div class="d-flex justify-content-between border-bottom">
						<h2 class="text-primary">Detalle Supervisor Externo</h2>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladoreditSupE.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="NOM_SUPENTEL"  id="NOM_SUPENTEL" value="<?php  echo $row['NOM_SUPENTEL']; ?> " disabled required/> </div>
                          </div>
                            <input type="hidden"  id="ID_SUPENTEL" name="ID_SUPENTEL" value="<?php  echo $row['ID_SUPENTEL']; ?> " >
                        </div>
                      </div>
                              ...
                              <a href="listadoSupE.php"><input class="btn btn-success" type="button" value="Volver"></a>
